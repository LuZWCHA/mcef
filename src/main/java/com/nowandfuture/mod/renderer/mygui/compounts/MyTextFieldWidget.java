...
class MyTextFieldWidget extends TextFieldWidget {
    ...
    public MyTextFieldWidget(FontRenderer fontRenderer, int x, int y, int width, int height, @org.jetbrains.annotations.Nullable TextFieldWidget inputWidget, ITextComponent title) {
        ...
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                if (drawShadow)
                    ...
                    j1 = this.fontRenderer.func_238422_b_(matrixStack, this.textFormatter.apply(s1, this.lineScrollOffset), (float) l, (float) i1, i2);
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                if (drawShadow)
                    ...
                    this.fontRenderer.func_238422_b_(matrixStack, this.textFormatter.apply(s.substring(j), this.cursorPosition), (float) j1, (float) i1, i2);
